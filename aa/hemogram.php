<?php
$pageTitle="HarSATGuru Lab|Hemogram Test";
?>
...
<div class="container"> 
	 	<div class=" single_top">
		  ...
		  <div class="banner-matter1">
					...
					<?php
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1021'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="hemogrambook.php" target="_blank" >ADD TO CART</a> 
	...
	<h3 class="clearfix"></h3>
				     				     	<p class="clearfix">This is a <b>Hemogram</b> health check-up.It include the tests related to red cells, white cells and platelets.</p>
				<div class="clearfix"> </div>
          	   </div>
