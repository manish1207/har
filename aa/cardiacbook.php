<?php
$pageTitle="HarSATGuru Lab|Cardiac Profile Test";
?>
<?php
...
<?php include('inc/head.php');?>
<body> <?php
$sql = "INSERT INTO test (test_id,user_id,test_i) VALUES ('1008',$a,'1008$a')";
if(mysqli_query($link, $sql)){
    echo "Cardiac Profile Test has been booked successfully";
} 
else{
    echo "				Already Booked";
	echo "</br>";echo "</br>";
