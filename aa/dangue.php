...
<div class="container"> 
	 	<div class=" single_top">
		  ...
		  <div class="banner-matter1">
			...
			<?php
 $sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1012'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="danguebook.php" target="_blank" >ADD TO CART</a> 
