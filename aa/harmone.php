<?php
$pageTitle="HarSATGuru Lab|HORMONE LEVELS";
?>
<?php
session_start();
...
<div class="container"> 
	 	<div class=" single_top">
		  ...
		  <div class="banner-matter1">
				...
				<?php
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1010'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="harmonebook.php" target="_blank" >ADD TO CART</a> 
	...
	<h3 class="clearfix"></h3>
				     				     	<p class="clearfix">This is a <b>Hormone</b> health check-up.It include the tests related to Hormones.</p>
				<div class="clearfix"> </div>
          	   </div>
