<?php
$pageTitle="HarSATGuru Lab|Bio, Enzymes, Electrolytes Test";
?>
<?php
...
$sql = "INSERT INTO test (test_id,user_id,test_i) VALUES ('1007',$a,'1007$a')";
if(mysqli_query($link, $sql)){
    echo "Bio, Enzymes, Electrolytes Test has been booked successfully";
} 
else{
    echo "				Already Booked";
	echo "</br>";echo "</br>";
