<?php
$pageTitle="HarSATGuru Lab|TYPHOID TEST";
?>
...
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1013'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="typhoidbook.php" target="_blank" >ADD TO CART</a> 
	...
	<h3 class="clearfix"></h3>
				     				     	<p class="clearfix">This is a <b>Typhoid </b> health check-up.It include the tests related to typhoid.</p>
				<div class="clearfix"> </div>
          	   </div>
