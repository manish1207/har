<?php
$pageTitle="HarSATGuru Lab|Kidney Count Test";
?>
<?php
...
<?php include('inc/head.php');?>
<body> <?php
$sql = "INSERT INTO test (test_id,user_id,test_i) VALUES ('1017',$a,'1017$a')";
if(mysqli_query($link, $sql)){
    echo "Kidney Test has been booked successfully";
} 
else{
    echo "				Already Booked";
	echo "</br>";echo "</br>";
