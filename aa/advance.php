<?php
$pageTitle="HarSATGuru Lab|Advance Test Package";
?>
...
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1001'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="advbook.php" target="_blank" >ADD TO CART</a> 
...
<?php include_once('inc/sub-cat.php');?>
	   		    <div class="clearfix"> </div>        	         
		</div>
