<?php
$pageTitle="HarSATGuru Lab|Serological Test Package";
?>
...
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  test_id='1003'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="serologicalbook.php" target="_blank" >ADD TO CART</a> 
	...
	<h3 class="clearfix"></h3>
				     	<p class="clearfix">This is a <b>Serological Test</b> health check-up.Include the tests related to Blood,VDRL etc.</p>
				<div class="clearfix"> </div>
          	   </div>
