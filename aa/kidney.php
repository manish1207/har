<?php
$pageTitle="HarSATGuru Lab|KIDNEY PANEL";
?>
...
<div class="container"> 
	 	<div class=" single_top">
		  ...
		  <div class="banner-matter1">
			...
			<?php
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1017'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="kidneybook.php" target="_blank" >ADD TO CART</a> 
	...
	<h3 class="clearfix"></h3>
				     				     	<p class="clearfix">This is a <b>Kidney</b> test.It include the tests related Kidney.</p>
				<div class="clearfix"> </div>
          	   </div>
