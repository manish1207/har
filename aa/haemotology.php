<?php
$pageTitle="HarSATGuru Lab|HAEMOTOLOGY";
?>
...
<div class="container"> 
	 	<div class=" single_top">
		  ...
		  <div class="banner-matter1">
					...
					$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1005'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="haemotologybook.php" target="_blank" >ADD TO CART</a> 
				 ...
				 <p> <?php echo $test_desc;?></p>
			    	...
			    	<h3 class="clearfix"></h3>
				     	<p class="clearfix">This is a <b>Haematology</b> health check-up.It include the tests related to blood count, platelet count etc.</p>
				<div class="clearfix"> </div>
			    </div>         
