<?php
$pageTitle="HarSATGuru Lab|BLOOD UREA";
?>
...
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1018'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="ureabook.php" target="_blank" >ADD TO CART</a> 
	...
	<h3 class="clearfix"></h3>
				     				     	<p class="clearfix">This is a <b>Blood Urea</b> test.It include the tests related Blood Urea.</p>
				<div class="clearfix"> </div>
          	   </div>
