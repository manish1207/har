...
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1009'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="liverbook.php" target="_blank" >ADD TO CART</a> 
	...
	<h3 class="clearfix"></h3>
				     				     	<p class="clearfix">This is a <b>Liver Profile</b> health check-up.It include the tests related to liver only.</p>
				<div class="clearfix"> </div>
          	   </div>
