...
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1007'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="beebook.php" target="_blank" >ADD TO CART</a> 
