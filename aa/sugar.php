<?php
$pageTitle="HarSATGuru Lab|SUGAR TEST";
?>
...
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1015'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="sugarbook.php" target="_blank" >ADD TO CART</a> 
	...
	<h3 class="clearfix"></h3>
				     				     	<p class="clearfix">This is a <b>Sugar</b> test.It include the tests related to check the amount of sugar in patient's body.</p>
				<div class="clearfix"> </div>
          	   </div>
