<?php
$pageTitle="HarSATGuru Lab | BLOOD GROUP TEST";
?>
...
<div class="container"> 
		...
		<?php
$sql=" SELECT tests_id, test_name, test_price, test_desc FROM tests WHERE  tests_id='1014'";
...
?>			</div>	<form method="post">
				    ...
				    <a type="button" class="now-get get-cart-in" href="bloodbook.php" target="_blank" >ADD TO CART</a> 
	...
	<h3 class="clearfix"></h3>
				     				     	<p class="clearfix">This is a <b>Blood Group </b> test.It include the tests related to check the blood group.</p>
				<div class="clearfix"> </div>
          	   </div>
